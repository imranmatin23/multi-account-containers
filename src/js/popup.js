/**
 * This file is only used when showing the onboarding tutorial steps. Therefore,
 * we are not going to go through it since it is not relevant to the core
 * functionality of multi-account containers.
 */
